...
abstract class HexUIModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexUIModDependenciesExtension>("hexuiModDependencies")
