...
class ComponentIota<T : ComponentBuilder<*, *>>(payload: T) : Iota(TYPE, payload) {
    ...
    override fun serialize(): NbtElement = component.serialize()
    ...
    companion object TYPE : IotaType<ComponentIota<*>>() {
        override fun deserialize(nbt: NbtElement, world: ServerWorld): ComponentIota<*> =
            ComponentIota(ComponentBuilderType.deserialize(nbt as NbtCompound, world))


        override fun display(tag: NbtElement?): Text = Text.literal("component")
